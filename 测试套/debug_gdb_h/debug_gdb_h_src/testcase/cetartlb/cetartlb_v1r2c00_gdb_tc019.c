...
#ifdef MMAP_64
    mmap_addr = (char *)mmap64((void *)ADDR, length, PROT_WRITE, MAP_SHARED|MAP_FIXED, tlb_fd, offset);
#else
    mmap_addr = mmap((void *)ADDR, length, PROT_WRITE, MAP_SHARED|MAP_FIXED, tlb_fd, offset);
#endif 
